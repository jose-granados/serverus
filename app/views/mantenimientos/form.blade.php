                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 tablas-margen">{{ Form::text( 'responsable_nombre',
                                            $mantenimientos->responsable_nombre, ['class'=>'form-control
                                            ','placeholder'=>'Nombre'] ) }}</div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Correo</label>
                                        <div class="col-sm-4 tablas-margen">{{ Form::text( 'responsable_correo',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 tablas-margen">{{ Form::text( 'responsable_telefono',
